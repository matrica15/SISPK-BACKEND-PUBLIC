...
namespace SISPK.Controllers.Perumusan
{
    ...
    public class RSNI3Controller : Controller
    {
        ...
        [HttpPost]
        public ActionResult Pengesahan(int PROPOSAL_ID = 0, int PROPOSAL_TAS_ID = 0, string PROPOSAL_TAS_DATE = "", int PROPOSAL_KOMTEK_ID = 0, string PROPOSAL_PNPS_CODE = "", int APPROVAL_TYPE = 0, int APPROVAL_STATUS = 1, string APPROVAL_REASON = "", int PROPOSAL_CLASIFICATION_ID = 0)
        {
            var USER_ID = Convert.ToInt32(Session["USER_ID"]);
            var DATENOW = MixHelper.ConvertDateNow();
            ...
            {
                db.Database.ExecuteSqlCommand("UPDATE TRX_PROPOSAL SET PROPOSAL_STATUS = 6,PROPOSAL_TAS_ID = " + PROPOSAL_TAS_ID + ", PROPOSAL_TAS_DATE = " + PROPOSAL_TAS_DATE_CONVERT + ",PROPOSAL_CLASIFICATION_ID = " + PROPOSAL_CLASIFICATION_ID + ", PROPOSAL_STATUS_PROSES = " + APPROVAL_STATUS + ", PROPOSAL_IS_POLLING = NULL, PROPOSAL_POLLING_ID = NULL, PROPOSAL_UPDATE_DATE = " + DATENOW + ", PROPOSAL_UPDATE_BY = " + USER_ID + " WHERE PROPOSAL_ID = " + PROPOSAL_ID);
                var PROPOSAL_LOG_CODE = db.Database.SqlQuery<string>("SELECT PROPOSAL_LOG_CODE FROM TRX_PROPOSAL WHERE PROPOSAL_ID = " + PROPOSAL_ID).SingleOrDefault();
                String objek1 = "UPDATE TRX_PROPOSAL SET PROPOSAL_STATUS = 6, PROPOSAL_STATUS_PROSES = " + APPROVAL_STATUS + ", PROPOSAL_IS_POLLING = NULL, PROPOSAL_POLLING_ID = NULL, PROPOSAL_UPDATE_DATE = " + DATENOW + ", PROPOSAL_UPDATE_BY = " + USER_ID + " WHERE PROPOSAL_ID = " + PROPOSAL_ID;
                MixHelper.InsertLog(PROPOSAL_LOG_CODE, objek1.Replace("'", "-"), 2);
