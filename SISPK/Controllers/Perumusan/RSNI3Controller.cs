...
namespace SISPK.Controllers.Perumusan
{
    ...
    public class RSNI3Controller : Controller
    {
        ...
        [HttpPost]
        public ActionResult Pengesahan(int PROPOSAL_ID = 0, int PROPOSAL_TAS_ID = 0, string PROPOSAL_TAS_DATE = "", int PROPOSAL_KOMTEK_ID = 0, string PROPOSAL_PNPS_CODE = "", int APPROVAL_TYPE = 0, int APPROVAL_STATUS = 1, string APPROVAL_REASON = "", int PROPOSAL_CLASIFICATION_ID = 0, string KLASIFIKASI_SNI = "")
        {
            var USER_ID = Convert.ToInt32(Session["USER_ID"]);
            var DATENOW = MixHelper.ConvertDateNow();
